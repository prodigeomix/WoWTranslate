...
```toml
# 1. OpenAI / ChatGPT (Cloud LLM - Highest Quality MMO Translations)
[[backends]]
type = "openai"
...
# 2. Ollama (100% Offline Local AI - Free)
...
# 3. DeepL API (Cloud - 500,000 Free Chars/month)
# [[backends]]
# type = "deepl"
# api_key = "YOUR_DEEPL_AUTH_KEY:fx"
# timeout = 15

# 4. Built-in Google Web Translate (Free Fallback — Zero Setup)
[[backends]]
type = "google"
timeout = 8
```
