...
title:SetText("WoWTranslate Configuration - v3.5.8")
...
function WoWTranslate_SetOutgoingButtonVisible(enabled)
    ...
    WT_ApplyOutgoingButtonVisibility()
end
...
function WoWTranslate_SetTranslateNameplates(val)
    ...
    if val and WT_wtNameplateScanStart then WT_wtNameplateScanStart() end
end
